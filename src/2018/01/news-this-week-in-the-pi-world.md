...
* **LibreELEC (Krypton) 8.2.3 MR:** It's been a while since I've looked for information about this *Media Center* that fixes some errors with *Samba*. | libreelec.tv
...
* **Raspberry Pi Zero WiFi Car:** Simple and concise. This *DIY* looks so easy that you'll want to make one this weekend. You dare? | omkarjr.in
