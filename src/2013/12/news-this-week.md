...
-   _Raspberry Pi_ has become the "toy" fashion, and many magazines from the electronics sector have regained benefits from articles that talk about it. _EveryDay Practical Electronic_ is one of them. I leave an article from the last number for those who want to see and if you want, purchase. Download: uploaded.to

-   New _Raspbian, Raspbmc and Arch_ updated images that you can install via _NOOBS_. More information on the official blog. Link: raspberrypi.org
