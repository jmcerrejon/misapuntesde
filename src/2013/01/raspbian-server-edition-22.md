...
In total **_242 packages_** (package list available [here](https://sirlagz.net/wp-content/uploads/2012/12/pkgs.txt)) have been uninstalled from the original Raspbian (2012-12-16 image). If you are interested you can run the script to remove the packages that don't need a server.
