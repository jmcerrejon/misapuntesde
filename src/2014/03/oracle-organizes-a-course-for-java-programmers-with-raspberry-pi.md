...
_Java_ skills is required. In addition, you also need to buy a Kit with all the necessary components for about _$89_. For more info, follow the link below.

Link: oracle.com > Oracle Massive Open Online Course: Develop Java Embedded Applications Using a Raspberry Pi
