...
Today it is easy to create one distro for your desktop or for embedded systems. In the case of _Linux_ we have plenty of tools to create an operating system according to our needs andto _Raspberry Pi_ we can build one using delog.wordpress.com... Don't you believe it?

This article is a translation into _Spanish_ from the blog delog.wordpress.com
...
Link: git.buildroot.net > raspberrypi
