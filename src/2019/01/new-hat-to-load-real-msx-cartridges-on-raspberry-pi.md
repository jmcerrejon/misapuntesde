...
- - -
The project is in an early stage, but games of the first *MSX* generation run without other big problems. *BlueberryMSX*, a ported *BlueMSX* by known *MRC* member *uberjack* supports the new extension so far, we hope for soon integration of [openMSX](https://misapuntesde.com/2017/10/new-openmsx-014-for-raspbian-stretch-deb.html).
