...
og_image: /images/2019/10/over.png
---
...
* **piRoot Beta 1, a Debian x86 executable:** and coming back to the issue of *x86 compatibility layers in ARM*, I came across this other project still in beta so that we can run a *chroot* of *Debian x86 applications in Raspbian*. | skywalkersw5.github.io
