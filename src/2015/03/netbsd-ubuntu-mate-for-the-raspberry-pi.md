...
For _NetBSD_, the port comes both for the Pi and _ODROID-C1_. In this link you will find the latest stable version for the Pi. The funny thing is that they have optimized the operating system to use the _GPU_ and support _omxplayer, OpenGL ES, Quake 3 or RetroArch_. Deserves a chance.
...
CentOS community is working in a version to _Pi2_ and _ODROID-C1_ that we hope to see soon.
