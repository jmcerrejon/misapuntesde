...
-   **OpenELEC 5.0.7.0. para ODROID-C1**: Aunque aún no cuenta con soporte oficial a través de openelec.tv, hay usuarios que se encargan de compilarlo para nuestras _ODROIDs_. Acabo de ver en el foro que se encuentra disponible esta versión con arreglos en audio/video y nuevo kernel. | Descarga: doukki.net > openelec-odroid-c1-5.0.7.0.img.gz
