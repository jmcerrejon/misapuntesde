...
livestreamer es un interface bajo línea de comandos _(CLI)_ que conecta diversos sistemas de streaming como _Dailymotion_, _Youtube Live_ entre otros,con tu reproductor de vídeo.

Twitchscript es un script en _Python_ para _Linux/Windows_ que te permite ver streams de _Twitch.tv_ con ayuda de _Livestreamer_ bajo la línea de comandos. Viene por defecto para ser usado con _VLC_, pero en nuestro caso lo usaremos con _omxplayer_.
