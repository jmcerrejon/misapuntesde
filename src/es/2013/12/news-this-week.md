...
-   _Raspberry Pi_ se ha convertido en el "juguete" de moda, y muchas revistas del sector de la electrónica han vuelto a tener beneficios gracias a artículos que hablan de ella. _EveryDay Practical Electronic_ es una de ellas. Os dejo un extracto del último número en descarga directa (en inglés, claro está) para aquellos que la quieran hojear. Descarga: uploaded.to

-   Nueva actualización de las imágenes de _Raspbian, Raspbmc y Arch_, que podrás instalar a través de _NOOBS v.1.3.3_. Más información en el blog oficial. Enlace: raspberrypi.org
