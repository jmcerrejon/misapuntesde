...
-   **Cómo controlar un GPIO a través de una página web:** Traducción con _Google Translate_ de un artículo donde se usa algo de ingenio para controlar la _GPIO_ a través de _PHP_. | Raspberry Pi - Cómo controlar Web GPIO / Cómo controlar un GPIO de la página web
